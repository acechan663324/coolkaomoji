                                ...
                                {category.symbols.map(({ char, name }) => (
                                    <div key={name} className="relative">
                                        <button
                                            ...
                                            title={name}
                                            className="w-full aspect-square flex items-center justify-center text-2xl bg-white rounded-lg border border-slate-200 hover:shadow-md hover:border-cyan-400 hover:-translate-y-1 transition-all duration-200"
